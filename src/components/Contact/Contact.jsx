            ...
            <div className={`${styles.wrap} ${styles.between}`}>
              <div className={styles.descriptionA}>
                <div>
                  ...
                  <div className={styles.icons_container}>
                    <Link to={isEnglish ? 'https://drive.google.com/file/d/1qeX4NoqEgZ8tedpb7MpwOZVeG1tooGhx/view?usp=sharing' : 'https://drive.google.com/file/d/1-72OeqYV6LsYTnaKSoDEQyM23ORVb7bg/view'} target='_blank' className={styles.circle_icons}>
