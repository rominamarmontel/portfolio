        ...
        <div className={styles.worksbox}>
          ...
          <button className={styles.work_container} onClick={() => setShowInvoice(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>Invoicer App<br />Déc 2023<br />Web application<br />TypeScript / Next.JS / MongoDB</div>
              </div>
            </div>
          </button>
          {showInvoice && (
          ...
          <button className={styles.work_container} onClick={() => setShowImperNext(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>Impermanence Films -NextJS ver.-<br />Nov 2023<br />Web application<br />TypeScript / Next.JS / MongoDB</div>
              </div>
            </div>
          </button>
          {showImperNext && (
          ...
          <button className={styles.work_container} onClick={() => setShowImper(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>Impermanence Films<br />Mai - Juil 2023<br />Web application<br />React.JS(Vite) / Node.JS(Express.JS) / MongoDB</div>
              </div>
            </div>
          </button>
          {showImper && (
          ...
          <button className={styles.work_container} onClick={() => setShowKanraku(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>KANRAKU HOSAI<br />Mars 2023<br />Projet final@IRONHACK<br />React.JS / Node.JS(Express.JS) / MongoDB</div>
              </div>
            </div>
          </button>
          {showKanraku && (
          ...
          <button className={styles.work_container} onClick={() => setShowExquisite(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>Exquisite Story<br />Feb. 2023<br />Équipe projet@IRONHACK<br />Node.JS(Express.JS) / Handlebars / MongoDB</div>
              </div>
            </div>
          </button>
          {showExquisite && (
          ...
          <button className={styles.work_container} onClick={() => setShowMonkey(true)}>
            <div className={styles.work_image}>
              ...
              <div className={styles.mask}>
                <div className={styles.caption}>WIN x WIN HAPPY MONKEY<br />Jan 2023<br />Projet solo@IRON<br />HTML / CSS / JavaScript</div>
              </div>
            </div>
          </button>
          {showMonkey && (
