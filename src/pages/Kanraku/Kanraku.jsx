      ...
      <div className={styles.container}>
        <div className={styles.top_container}>
          <div className={styles.text}>
            <p className={styles.date}>Mars 2023 | Projet final chez Ironhack</p>
            <div className={styles.titleTop}>
              <h2 className={styles.title}>Kanraku Hosai</h2>
              <div className={styles.sns}>
                <Link to='https://github.com/rominamarmontel/nagasekikaku-frontend' target="_blank" rel="noopener noreferrer"><FaGithub /></Link>
                <Link to='https://hosai.netlify.app/' target="_blank" rel="noopener noreferrer"><PiLinkSimpleFill /></Link>
              </div>
            </div>
