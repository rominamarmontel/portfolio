      ...
      <div className={styles.container}>
        <div className={styles.top_container}>
          <div className={styles.text}>
            <p className={styles.date}>Mai - Juil 2023</p>
            <div className={styles.titleTop}>
              <h2 className={styles.title}>Impermanence Films</h2>
              <div className={styles.sns}>
                <Link to='https://github.com/rominamarmontel/impermanence-front' target="_blank" rel="noopener noreferrer"><FaGithub /></Link>
                <Link to='https://www.impermanencefilms.org/' target="_blank" rel="noopener noreferrer"><PiLinkSimpleFill /></Link>
              </div>
            </div>
